...
<link rel="stylesheet" href="{{ asset('css/style.css') }}">
  ...
  <body>
    ...
    <div class="container">
        <a class="navbar-brand" href="index.php">POWER<strong>HAUL</strong></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto align-items-center">
                ...
                <li class="nav-item"><a href="cars.php" class="nav-link">Our Car</a></li>
                <li class="nav-item"><a href="blog.php" class="nav-link">Blog</a></li>

                <!-- LOGIN BUTTON (sejajar dengan menu lain) -->
                <li class="nav-item">
                    <a href="{{ route('login') }}" class="btn btn-warning" style="margin-left: 15px; font-weight: 600;">
    LOGIN
</a>
                </li>
            </ul>
    ...
    <div class="hero-wrap" style="background-image: url('images/construction-truck.jpg');" data-stellar-background-ratio="0.5">
